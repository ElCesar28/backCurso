...
def tarjeta_detail_api_view(request, pk=None):
    # Encontrar la tajeta específica por su clave primaria (pk)
    ...
    if tarjeta:
        ...
        if request.method == 'GET':
            ...
            return Response(tarjeta_serializer.data, status=status.HTTP_200_OK) # Respuesta con los datos del usuario
