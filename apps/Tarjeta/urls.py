...
from apps.Tarjeta.api import tarjeta_api_view, tarjeta_detail_api_view
...
urlpatterns = [
    ...
    # URL para operaciones específicas de un tarjeta (obtener detalles, actualizar, eliminar)
